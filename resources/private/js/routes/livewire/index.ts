...
* @route '/livewire-ff4b31d3/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-ff4b31d3/upload-file',
...
* @route '/livewire-ff4b31d3/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-ff4b31d3/preview-file/{filename}',
